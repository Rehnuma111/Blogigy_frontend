  ...
  return (
    <>
      <div className="">
        <button
          type="button"
          className=" border border-orange-500 flex items-center justify-center gap-2 active:scale-x-95 rounded-md w-full py-2 transition-all"
          onClick={googleFirebaseAuthBtn}
        >
          <FcGoogle size={20} />
