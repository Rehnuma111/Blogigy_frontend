  ...
  return (
    <>
      <div className="md:flex-row flex-col flex md:gap-10  items-center md:justify-center min-h-screen ">
        ...
        {/* Right Content : */}
        <form
          className="md:w-1/3 w-80 flex flex-col gap-2"
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            <label className="flex ">
              Email{" "}
              <span className="font-semibold text-red-400 text-xl">*</span>
            </label>
            <input
              type="email"
              name="email"
              placeholder="youremail@gmail.com"
              className={`border outline-none  rounded-md py-2 px-3 bg-blue-50 border-blue-400 ${
                theme === "dark" &&
                "bg-gray-700 text-gray-100 focus:bg-gray-800 transition-all"
              }`}
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`border outline-none rounded-md py-2 px-3 border-blue-400 bg-blue-50 ${
                theme === "dark" &&
                "bg-gray-700 focus:bg-gray-800 text-gray-100"
              }`}
          ...
          <div className="w-full">
            <button
              disabled={isLoading}
              type="submit"
              className="bg-blue-500 text-white font-semibold rounded-md w-full py-2 my-4 active:bg-blue-600 transition-all"
            >
              {isLoading ? (
